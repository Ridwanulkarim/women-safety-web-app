      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-10 border-b border-zinc-800/80">
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-1.5 text-xs">
              ...
              <li><Link to="/safety-tips" className="hover:text-white transition">{t('safetyTips')}</Link></li>
          ...
          <div className="space-y-2">
            <h4 className="text-white font-bold text-xs tracking-wider uppercase font-mono flex items-center gap-1.5">
              <FiPhoneCall className="text-rose-500" /> {t('footerHotlines')}
            </h4>
            <ul className="space-y-1.5 text-xs font-mono">
              <li className="flex justify-between items-center text-zinc-300">
                <span>{t('nationalService')}</span>
          ...
          <div className="space-y-2">
            <h4 className="text-white font-bold text-xs tracking-wider uppercase font-mono flex items-center gap-1.5">
              <FiLock className="text-emerald-500" /> {t('footerTelemetry')}
            </h4>
            <p className="text-xs text-zinc-400 leading-relaxed font-normal">
              {t('footerSecurity')}
            </p>
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono text-zinc-500">
          ...
          <div className="flex gap-4">
            <Link to="/contact" className="hover:text-zinc-300 transition">{t('supportLink')}</Link>
            <Link to="/safety-tips" className="hover:text-zinc-300 transition">{t('securityProtocolLink')}</Link>
          </div>
        </div>
      </div>
    </footer>
